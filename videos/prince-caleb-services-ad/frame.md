...
typography:
  ...
  h3:      { fontFamily: "Inter", cqw: 2.8, weight: 400, lineHeight: 1.2, lower: true }
  quote-text:{ fontFamily: "Inter", cqw: 3.8, weight: 850, lineHeight: 1.15, tracking: "-0.02em", lower: true }
  h2:      { fontFamily: "Inter", cqw: 4.5, weight: 850, lineHeight: 1.1, tracking: "-0.02em", lower: true }
  stat-value:{ fontFamily: "Inter", cqw: 5.5, weight: 900, lineHeight: 1.0, tracking: "-0.04em" }
  h1:      { fontFamily: "Inter", cqw: 7.5, weight: 850, lineHeight: 0.9, tracking: "-0.03em", lower: true }
...
- **Fonts** — already set to **Inter** (display) / **Cascadia Code** (body); ignore any preset font name lingering in prose.
- **Weights** — the brand font ships `{400, 850, 900}` only; every weight is clamped to these — ignore higher preset weights (e.g. 600/700) in prose.
