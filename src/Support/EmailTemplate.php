...
class EmailTemplate
{
    ...
    public static function sampleVars(string $recipientEmail = 'client@example.com'): array
    {
        return [
            ...
            'invoice_number' => 'INV-2041', 'invoice_url' => 'https://princecaleb.dev/invoice?id=test',
            'due_line' => 'Payment is due by 30 July 2026.',
            'booking_url' => 'https://princecaleb.dev/book',
            'proposal_title' => 'Restaurant booking platform', 'proposal_url' => 'https://princecaleb.dev/proposal?id=test',
            'portal_url' => 'https://princecaleb.dev/client/', 'reset_url' => 'https://princecaleb.dev/client/reset?token=test',
            'testimonial_url' => 'https://princecaleb.dev/testimonial?token=test', 'project_reference_line' => ' on the booking platform',
            'payment_url' => 'https://princecaleb.dev/pay?id=test', 'milestone_title' => 'Milestone 2 — Build',
