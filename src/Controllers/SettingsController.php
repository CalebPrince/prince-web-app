...
class SettingsController
{
    ...
    private const ADMIN_ONLY_KEYS = [
        ...
        'typesafe_api_key', 'typesafe_gate_mode', 'typesafe_score_threshold', 'typesafe_competitor_cutoff',
        'typesafe_cost_per_call_usd', 'beacon_full_call_cost_usd',
    ...
    private const CONTENT_KEYS = [
        ...
        'hero_security_title', 'hero_security_text',
        'working_together_title', 'working_together_intro',
        'project_standards_title', 'project_standards_intro',
        'project_step_1_title', 'project_step_1_body',
        'project_step_2_title', 'project_step_2_body',
        'project_step_3_title', 'project_step_3_body',
        'project_step_4_title', 'project_step_4_body',
        'security_eyebrow', 'security_title', 'security_intro',
        'security_control_1_label', 'security_control_1_title', 'security_control_1_body',
        'security_control_2_label', 'security_control_2_title', 'security_control_2_body',
        'security_control_3_label', 'security_control_3_title', 'security_control_3_body',
        'security_control_4_label', 'security_control_4_title', 'security_control_4_body',
        'security_ledger_1_label', 'security_ledger_1_value',
        'security_ledger_2_label', 'security_ledger_2_value',
        'security_ledger_3_label', 'security_ledger_3_value',
        'security_ledger_4_label', 'security_ledger_4_value',
        'security_ledger_5_label', 'security_ledger_5_value',
        'security_disclaimer',
    ...
    public static function adminUpdate(): void
    {
        ...
        foreach (array_merge(self::ADMIN_ONLY_KEYS, self::CONTENT_KEYS) as $key) {
            ...
            if (in_array($key, ['smtp_gmail_address', 'mail_from', 'dataforseo_login'], true)
            ...
            if ($key === 'whatsapp_provider' && !in_array($value, ['whapi', 'elevenlabs', 'wati', 'twilio'], true)) {
                Response::error('Choose Whapi, ElevenLabs, Wati, or Twilio as the WhatsApp provider.', 422);
            }
