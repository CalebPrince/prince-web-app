    ...
    private static function autoDraft(\PDO $pdo, int $limit): array
    {
        ...
        foreach ($leads as $lead) {
            ...
            if (filter_var($email, FILTER_VALIDATE_EMAIL)) {
                ...
                $caseStudy = MarketingLeadController::findCaseStudyForLead($pdo, (int) $lead['id']);
                $pitch = MarketingLeadController::draftPitch((string) $lead['business_name'], $findings, $demoUrl, (int) $lead['id'], $caseStudy);
                if ($pitch === null) {
