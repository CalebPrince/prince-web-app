...
{$link}";
    ...
    private static function promptForContentIdea(array $idea, array $research = [], ?array $source = null): string
    {
        ...
        return $base . "Write a LinkedIn post based on this content idea from Caleb's own content calendar:\n"
            ...
            . "2. PROBLEM: name the familiar behavior, how businesses usually handle this today. Where it helps, "
            . "show it as a quick sequence of short lines.\n"
            ...
            . "4. INSIGHT AND PRACTICAL EXAMPLE: make it concrete with 3 to 5 short points, each on its own line "
            . "starting with the arrow character \u{2192}, showing what is now possible or what was there all along.\n"
