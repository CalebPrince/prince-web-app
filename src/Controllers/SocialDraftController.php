...
{$link}";
    ...
    private static function promptForContentIdea(array $idea): string
    {
        ...
        return $base . "Write a LinkedIn post based on this content idea from Caleb's own content calendar:\n"
            ...
            . "- Finish with one specific question, then a short call to action on its own last line that fits this "
            . "post's content. Vary it and pick what suits the topic, for example: Leave your comments below. / "
            . "Tell me which one you're dealing with in the comments. / Drop your take below, I read every reply. / "
            . "Agree or disagree? Say why in the comments. / What would you add? Comment below. / "
            . "Tag a business owner who needs to see this. Never promise something Caleb hasn't offered, "
            . "such as a free download, audit or discount.\n"
