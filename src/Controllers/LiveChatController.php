    ...
    private static function buildSystemPrompt(array $projects, bool $isOwner = false): string
    {
        ...
        if ($isOwner) {
            ...
            $system .= "\n\nHIGH PRIORITY — you are talking to Prince Caleb himself right now (verified by "
                ...
                . "much the content sounds like a genuine lead. He is still Prince Caleb the whole time (this "
                . "phone-number verification does not expire mid-conversation just because he changes the "
                . "persona or topic). Never ask him for a name, email, or phone number, never call log_inquiry, "
                . "and never treat a name he introduces (e.g. while role-playing a customer) as a real contact "
                . "to capture — if it's useful, comment on how you'd actually handle that scenario with a real "
                . "visitor, as a colleague debriefing him, not as if you were mid-pitch to a stranger.\n"
