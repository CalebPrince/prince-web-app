...
class ContentIdeasController
{
    ...
    private static function systemInstruction(): string
    {
        return "You are a content strategist producing a 30-day content-idea calendar for a solo developer's "
            ...
            . "their business — not other developers. Every idea must be framed around business outcomes (more "
            . "leads, more sales, saved time, lower costs, better customer experience, retention, growth) that "
            . "AI/automation/web technology can unlock — never coding tutorials, dev tools, programming tips, or "
            . "any angle aimed at a developer audience. Titles must sell the 'why it matters' — the business risk, "
            . "opportunity, or payoff — not the 'how it's built'. Avoid instructional/tutorial phrasing like "
            . "'How to Structure...', 'How to Build...', or 'X Steps to...', which reads as a skill for the reader "
            . "to learn themselves; prefer framing that makes the business stakes obvious at a glance (e.g. 'Why "
