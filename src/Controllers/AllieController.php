    ...
    private static function searchNewsSitesToolDeclaration(): array
    {
        return [
            ...
            'description' => 'A live web search restricted to a curated list of tech and AI news outlets (by default VentureBeat, ' .
                'TechCrunch and HeadsUpAI for global AI news, plus Tech Labari, TechCabal and CIO Africa for Ghana and Africa, editable in ' .
                'Settings), biased to the past month. The African outlets cover the whole continent, so include "Ghana" or "Africa" in the query ' .
                'when local context matters to Caleb, who is based in Accra. Use it to see what the ' .
