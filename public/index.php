...
use App\Controllers\GoogleReviewController;
...
use App\Controllers\AgentTaskController;
...
$router->post('/api/v1/voice/elevenlabs/init', [VoiceDemoController::class, 'elevenLabsInitWebhook']);
$router->post('/api/v1/voice/elevenlabs/tool', [VoiceDemoController::class, 'elevenLabsToolWebhook']);
$router->post('/api/v1/voice/elevenlabs/post-call', [VoiceDemoController::class, 'elevenLabsPostCallWebhook']);
...
$router->post('/api/v1/whatsapp/twilio-webhook', [LiveChatController::class, 'twilioWebhook']);
...
$router->get('/api/v1/admin/agent-tasks', [AgentTaskController::class, 'index']);
$router->post('/api/v1/admin/agent-tasks/{id}/retry', [AgentTaskController::class, 'retry']);
$router->post('/api/v1/admin/agent-tasks/{id}/cancel', [AgentTaskController::class, 'cancel']);
...
$router->get('/api/v1/admin/voice-demo/stats', [VoiceDemoController::class, 'adminStats']);
...
$router->get('/api/v1/admin/sage-chats', [SageController::class, 'adminIndex']);
$router->patch('/api/v1/admin/sage-chats/{id}', [SageController::class, 'markSeen']);
...
$router->post('/api/v1/admin/marketing-leads/{id}/account-demo/generate', [AccountDemoController::class, 'generate']);
$router->patch('/api/v1/admin/marketing-leads/{id}/account-demo', [AccountDemoController::class, 'update']);
...
$router->post('/api/v1/admin/whatsapp/send-message', [LiveChatController::class, 'sendAdminWhatsAppMessage']);
...
$router->get('/api/v1/admin/whatsapp-template/owner-alert', [WhatsAppOwnerAlertTemplateController::class, 'status']);
$router->post('/api/v1/admin/whatsapp-template/owner-alert', [WhatsAppOwnerAlertTemplateController::class, 'create']);
$router->post('/api/v1/admin/whatsapp-template/owner-alert/refresh', [WhatsAppOwnerAlertTemplateController::class, 'refresh']);
...
$router->post('/api/v1/admin/whatsapp-template/project-kickoff', [WhatsAppProjectKickoffTemplateController::class, 'create']);
$router->post('/api/v1/admin/whatsapp-template/project-kickoff/refresh', [WhatsAppProjectKickoffTemplateController::class, 'refresh']);
...
$router->get('/api/v1/admin/sites', [SiteController::class, 'adminIndex']);
$router->get('/api/v1/admin/sites/{id}', [SiteController::class, 'adminShow']);
$router->get('/api/v1/admin/sites/{id}/analytics', [SiteController::class, 'analytics']);
$router->post('/api/v1/admin/agents/chloe/chat', [ChloeController::class, 'chat']);
$router->get('/api/v1/admin/chloe/incidents', [ChloeController::class, 'incidentsIndex']);
