...
export const SERVICES: Service[] = [
  {
    ...
    body: "Custom website design, landing pages and redesigns. I plan your pages, shape the visual direction and design responsive layouts for your approval before development.",
    features: [
...
export const HOME_SERVICES: Service[] = [
  {
    ...
    title: "Website Design & UX/UI",
    tagline: "Clarity before code",
    body: "Custom websites, landing pages and redesigns, from page structure and visual identity to responsive layouts you review before development.",
    features: [
      { icon: Compass, label: "Website structure and user journeys" },
